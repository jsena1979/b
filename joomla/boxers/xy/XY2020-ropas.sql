...
update ljul_articulos_tango_exp set Description = replace(Description,'  ',' ') where marca='XY-ROPAS';
...
where 
marca='XY-ROPAS'
select distinct(talle)  from ljul_articulos_tango_exp where marca='XY-ROPAS' order by talle;
