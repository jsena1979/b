...
replace(concat(marca,'-Art-',codigo,'-',SKUCode),'/','-') as slug,
 ...
 'Y' as published,
 'Lenceria de Mujer/Bianca Secreta' as category_path ,
 concat(concat(AdditionalDescription,' ',marca,'-Art:',codigo),'<br />',coalesce(vm_description(0,codigo),concat(talle,' - ',color))) as product_desc,Description,
   (CASE 
        ...
        WHEN trim(talle)='75' or trim(talle)='T75' or trim(talle)='T.75'then 2
        WHEN trim(talle)='T80' or trim(talle)='80' or trim(talle)='T.80' then 3 
        WHEN trim(talle)='T85' or trim(talle)='85' or trim(talle)='T1' or trim(talle)='T01'  or trim(talle)='T.1' or trim(talle)='T.85' then 4 
        WHEN trim(talle)='T90' or trim(talle)='90' or trim(talle)='T2' or trim(talle)='T02'  or trim(talle)='T.2' or trim(talle)='T.90' then 5
        WHEN trim(talle)='T95' or trim(talle)='95' or trim(talle)='T3' or trim(talle)='T03'  or trim(talle)='T.3' or trim(talle)='T.95' then 6  
        WHEN trim(talle)='T100' or trim(talle)='100'or trim(talle)='T4' or trim(talle)='T04'  or trim(talle)='T.4' or trim(talle)='T.100' then 7
		WHEN trim(talle)='T105' or trim(talle)='105' or trim(talle)='T5' or trim(talle)='T05'  or trim(talle)='T.5' or trim(talle)='T.105' then 8

		WHEN trim(talle)='T110' or trim(talle)='110' or trim(talle)='T6' or trim(talle)='T06'  or trim(talle)='T.6' or trim(talle)='T.110' then 8.1
		WHEN trim(talle)='115' or trim(talle)='T115' or trim(talle)='T7' or  trim(talle)='T07'  or trim(talle)='T.7' or trim(talle)='7' or trim(talle)='T.115'then 8.2
        WHEN trim(talle)='120' or trim(talle)='T120' or trim(talle)='T8' or  trim(talle)='8' or trim(talle)='T08'  or trim(talle)='T.8' or trim(talle)='T.120'then 8.3
        ...
        WHEN 'T39-40'then 39
        WHEN 'T41-42'then 41
		WHEN trim(talle)='42' or trim(talle)='T42' or trim(talle)='T.42'then 42
        WHEN 'T43-44'then 43
        WHEN 'T45-46'then 45        
...
from ljul_articulos_tango_exp t where marca ='BIANCA'
