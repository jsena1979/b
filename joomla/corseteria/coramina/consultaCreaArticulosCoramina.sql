...
replace(concat(marca,'-Art-',codigo,'-',SKUCode),'/','-') as slug,
 ...
 'Y' as published,
 'Lenceria de Mujer/Coramina' as category_path ,
...
from ljul_articulos_tango_exp t where marca ='CORAMINA'
and AdditionalDescription <> 'PIJAMA' 
and AdditionalDescription <>'ROPA DE DORMIR'
