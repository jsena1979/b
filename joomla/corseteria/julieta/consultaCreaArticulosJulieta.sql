...
replace(concat(marca,'-Art-',codigo,'-',SKUCode),'/','-') as slug,
 ...
 'Y' as published,
 'Lenceria de Mujer/LENCERIA JULIETA' as category_path ,
...
from ljul_articulos_tango_exp t where marca ='LENCERIA JULIETA'
and AdditionalDescription <> 'PIJAMA' ljul_articulos_tango
