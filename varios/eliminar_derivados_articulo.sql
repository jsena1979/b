DROP PROCEDURE IF EXISTS eliminar_derivados_articulos;
DELIMITER $$
CREATE PROCEDURE `eliminar_derivados_articulos`( in marca varchar(500),in parent_id int)
begin
...
call eliminar_derivados_articulos('LENCATEX',0);
